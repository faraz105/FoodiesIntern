...
const Components = ({open,handleClose, textButton}) => {
        ...
        <form>
          <Fade in={open}>
            <Box className="parent" sx={style}>
              ...
              >
                <Typography style={{ fontSize: 20, fontWeight: 400}}>Add New User</Typography>
                <Typography onClick={handleClose} style={{color: 'white', background: 'rgb(245, 126, 42)', borderRadius:'50%', width: 30, height: 30, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center'}}>X</Typography>
              </div>
  ...
  <label htmlFor="" style={{fontSize: 20, fontWeight: 400, lineHeight: '25.3px'}}>User Name</label>
  <br /><br />
  <input
    type="text"
    name="name"
  ...
  />
                ...
                <div className="innerinput">
                  <label htmlFor=""style={{fontSize: 20, fontWeight: 400, lineHeight: '25.3px'}}>Email</label>
                  <br /><br />
                  <input
                    type="email"
                    name="email"
